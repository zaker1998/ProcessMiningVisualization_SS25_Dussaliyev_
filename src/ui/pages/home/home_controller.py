...
from core.analysis.detection import DetectionModel
...
class HomeController(BaseController):
    ...
    def __init__(
        ...
        if views is None:
            from ui.pages.home.home_view import HomeView
    ...
    def _get_sample_files(self):
        ...
        samples = []
        # Navigate from ui/pages/home to src, then up to project root, then to tests/fixtures/samples
        src_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
        sample_dir = os.path.join(src_dir, "..", "tests", "fixtures", "samples")
