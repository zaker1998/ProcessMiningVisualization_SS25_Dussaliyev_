...
class TestHeuristic(unittest.TestCase):
    ...
    def __run_test_txt(self, filename):
        heuristicMining = HeuristicMining(
            cases_list_to_dict(self.__read_cases("tests/fixtures/logs/" + filename + ".txt"))
        )
    ...
    def __run_test_csv(self, threshold, min_freq):
        heuristicMining = HeuristicMining(read("tests/fixtures/csv/test_csv.csv"))
    ...
    def __run_CallcenterExample_csv(self, threshold, min_freq):
        heuristicMining = HeuristicMining(
            read(
                "tests/fixtures/csv/CallcenterExample.csv",
